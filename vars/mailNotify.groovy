...
def call(
    ...
    mail to: Properties.Emails.EMAIL_TEST,
        ...
        subject: "Report of CTC DB structure changes: ${dbUtils.versionGet()}_${Properties.RawArtifact.code}",
        body:  '''<p>Dear Colleagues,</p>
                        ...
                        <p> </p>
                        <p>Thank you.</p>''',
        attachmentsPattern: "${Properties.Paths.DIFFERENCE_DB_DIR}${dbUtils.versionGet()}_${Properties.RawArtifact.code}.txt"
}
